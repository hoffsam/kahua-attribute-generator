...
async function handleSelection(mode) {
    ...
    const tokenNamesConfig = vscode.workspace.getConfiguration().get('kahua.tokenNames') || 'name,prefix,type,label';
    ...
    const outputTarget = vscode.workspace.getConfiguration().get('kahua.outputTarget') || 'clipboard';
